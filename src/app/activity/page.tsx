    ...
    return (
      <div className="min-h-screen bg-autensa-bg flex items-center justify-center">
        <div className="text-center">
          <Activity className="w-8 h-8 text-autensa-accent mx-auto mb-3 animate-pulse" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Link href="/" className="text-autensa-text-secondary hover:text-autensa-text transition-colors">
                <ArrowLeft className="w-5 h-5" />
              </Link>
              <Activity className="w-6 h-6 text-autensa-accent" />
              <h1 className="text-xl font-bold text-autensa-text">Activity Dashboards</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        {workspaces.length === 0 ? (
          <div className="text-center py-20">
            <Activity className="w-12 h-12 text-autensa-text-secondary mx-auto mb-4" />
            <h2 className="text-xl font-bold text-autensa-text mb-2">No workspaces</h2>
            <p className="text-autensa-text-secondary">Create a workspace to see agent activity.</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="font-semibold text-autensa-text group-hover:text-autensa-accent transition-colors">
                        {ws.name}
                      </h3>
                      <span className="text-xs text-autensa-text-secondary">/{ws.slug}</span>
                    </div>
