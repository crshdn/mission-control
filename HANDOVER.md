...
Do not use old handover notes as current operating guidance for the rebuilt v2.4.0 branch.
...
If a future session needs a fresh handover, create a new date-stamped document that matches the current checklist instead of appending to older verifier-era notes.
