...
await fetch(`http://YOUR_SERVER_IP:3000/api/tasks/${taskId}/activities`, {
  method: 'POST',
...
```typescript
await fetch(`http://YOUR_SERVER_IP:3000/api/tasks/${taskId}/deliverables`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
await fetch(`http://YOUR_SERVER_IP:3000/api/tasks/${taskId}/subagent`, {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
1. **Open two browser windows:**
   - Window 1: http://YOUR_SERVER_IP:3000
   - Window 2: http://YOUR_SERVER_IP:3000
...
curl -X POST http://YOUR_SERVER_IP:3000/api/tasks \
