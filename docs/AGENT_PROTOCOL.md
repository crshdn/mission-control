...
> Historical note only. This document reflects an older direct `TASK_COMPLETE` / orchestrator-centric protocol and should not be treated as the verified local contract for the rebuilt v2.4.0 branch. Use [VERIFICATION_CHECKLIST.md](/Users/jordan/.openclaw/workspace/mission-control/VERIFICATION_CHECKLIST.md) and [HOW-THE-PIPELINE-WORKS.md](/Users/jordan/.openclaw/workspace/mission-control/docs/HOW-THE-PIPELINE-WORKS.md) for current guidance.
